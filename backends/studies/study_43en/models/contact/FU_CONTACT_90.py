...
class FU_CONTACT_90(AuditFieldsMixin):
    """
    Contact follow-up at Day 90
    Extended healthcare exposure and medication tracking
    ...
    class Meta:
        ...
        ordering = ['-ASSESSDATE']
        indexes = [
            models.Index(fields=['ASSESSDATE'], name='idx_cfu90_assess'),
            models.Index(fields=['ASSESSED', 'ASSESSDATE'], name='idx_cfu90_asses_date'),
            models.Index(fields=['MEDICATION_USE'], name='idx_cfu90_med'),
            models.Index(fields=['last_modified_by_id', '-last_modified_at'], name='idx_cfu90_modified'),
        ]
        constraints = [
            ...
            models.CheckConstraint(
                ...
                name='cfu90_assess_date_required'
            ),
        ]
    
    def __str__(self):
        return f"Contact FU Day 90: {self.USUBJID_id}"
