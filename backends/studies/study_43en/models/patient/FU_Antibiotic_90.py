...
class FollowUpAntibiotic90(AuditFieldsMixin):
    """
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['USUBJID', 'Antb_Usage_No'], name='idx_fua90_subj_ep'),
            models.Index(fields=['Antb_Name'], name='idx_fua90_name'),
            models.Index(fields=['last_modified_by_id', '-last_modified_at'], name='idx_fua90_modified'),
        ]
        constraints = [
            models.UniqueConstraint(
                fields=['USUBJID', 'Antb_Usage_No'],
                name='unique_fu_antibio90_episode'
            ),
        ]
    ...
    def bulk_create_for_patient(cls, usubjid, antibiotic_list, user=None):
        ...
        Returns:
            List of created FollowUpAntibiotic90 instances
        """
