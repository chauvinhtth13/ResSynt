...
class Rehospitalization90(AuditFieldsMixin):
    """
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['USUBJID', 'REHOSP_No'], name='idx_rh90_subj_ep'),
            models.Index(fields=['ReHospDate'], name='idx_rh90_date'),
            models.Index(fields=['USUBJID', 'ReHospDate'], name='idx_rh90_subj_date'),
            models.Index(fields=['last_modified_by_id', '-last_modified_at'], name='idx_rh90_modified'),
        ]
        constraints = [
            models.UniqueConstraint(
                fields=['USUBJID', 'REHOSP_No'],
                name='unique_rehosp90_episode'
            ),
        ]
    ...
    @property
    def SITEID(self):
        """Get SITEID from related FU_CASE_90"""
    ...
    def clean(self):
        """Enhanced validation - MINIMAL (Day 90)"""
        errors = {}
