...
# ==========================================
# FOLLOW-UP DAY 28 MAIN FORM
# ==========================================

class FollowUpCaseForm(forms.ModelForm):
    """Form for FU_CASE_28 model (Day 28)"""

    #  UPDATED: Field names and labels match model
    EvaluatedAtDay28 = forms.ChoiceField(
        choices=[('No', 'No'), ('Yes', 'Yes'), ('NA', 'Not Applicable')],
        widget=forms.RadioSelect(attrs={'class': 'form-check-input'}),
        initial='No',
        required=True,
        label=_("1. The patient's condition was assessed on Day 28?")
    )
    ...
    Func_Status = forms.ChoiceField(
        ...
        initial='No',
        required=False,
        label=_('5. Assessment of Functional Status at Day 28?')
    )

    class Meta:
        model = FU_CASE_28
        fields = [
            'EvaluatedAtDay28', 'EvaluateDate', 'Outcome28Days',
    ...
    def clean(self):
        ...
        Validates data integrity based on choices
        """
        cleaned_data = super().clean()
        errors = {}

        # Validate EvaluatedAtDay28 dependencies
        evaluated = cleaned_data.get('EvaluatedAtDay28')
        if evaluated == 'Yes':
...
# ==========================================
# REHOSPITALIZATION FORM (DAY 28)
# ==========================================

class RehospitalizationForm(forms.ModelForm):
    """
    Form for Rehospitalization records (Day 28)
     UPDATED: Field names and labels match model
    """
...
# ==========================================
# ANTIBIOTIC FORM (DAY 28)
# ==========================================

class FollowUpAntibioticForm(forms.ModelForm):
    """
    Form for FollowUpAntibiotic records (Day 28)
     UPDATED: Field names and labels match model
    """
...
# ==========================================
# BASE FORMSETS (DAY 28)
# ==========================================

class BaseRehospitalizationFormSet(forms.BaseInlineFormSet):
    """
    Base formset for Rehospitalization with auto episode numbering
...
class BaseFollowUpAntibioticFormSet(forms.BaseInlineFormSet):
    """
    Base formset for FollowUpAntibiotic with auto episode numbering
