...
# ==========================================
# FOLLOW-UP DAY 90 MAIN FORM (CONTACT)
# ==========================================

class ContactFollowUp90Form(forms.ModelForm):
    """
    Form for FU_CONTACT_90 model
    
    Features:
    - Same structure as Day 28 form
    ...
    ASSESSED = forms.ChoiceField(
        ...
        initial='No',
        required=True,
        label=_('Close contacts were assessed as of Day 90?')
    )
...
class BaseContactMedicationHistory90FormSet(forms.BaseInlineFormSet):
    """
    Base formset for ContactMedicationHistory90 with auto episode numbering
...
ContactMedicationHistory90FormSet = forms.inlineformset_factory(
    ...
    formset=BaseContactMedicationHistory90FormSet,
    extra=1,
    can_delete=False,
    min_num=0,
    validate_min=False,
