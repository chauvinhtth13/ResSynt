...
#     class Meta:
#         # Changed to managed=True to allow Django to create migrations
#         # This model will be used directly by all studies
#         managed = True
...
#             logger.error(
#                 f"🚨 INTEGRITY VIOLATION: AbstractAuditLog {self.id} checksum mismatch!\n"
