# backends/api/studies/study_43en/views/contact/sample/helpers.py
"""
Contact Sample Collection Helper Functions.

Provides query optimization and data processing utilities.
"""
import logging
...
from backends.studies.study_43en.models.contact import (
    SCR_CONTACT, ENR_CONTACT, SAM_CONTACT,
)
