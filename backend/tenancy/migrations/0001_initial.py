# Generated by Django 5.2.4 on 2025-09-22 10:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_study_accessed_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Last Study Access Time"
                    ),
                ),
                (
                ...
                (
                    "password_changed_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Password Changed At"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["category", "code"], name="idx_perm_cat_code")
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["permission"], name="idx_roleperm_permission"),
                ],
                "constraints": [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "site_id",
                    models.IntegerField(
                        blank=True, db_index=True, null=True, verbose_name="Site ID"
                    ),
                ),
                (
                    "object_id",
                ...
                (
                    "table_name",
                    models.CharField(
                        db_index=True, max_length=100, verbose_name="Table Name"
                    ),
                ),
                (
                    "record_display",
                ...
                (
                    "performed_at",
                    models.DateTimeField(
                        auto_now_add=True, db_index=True, verbose_name="Performed At"
                    ),
                ),
                (
                    "ip_address",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["study", "performed_at"], name="idx_audit_study_time"
                    ),
                    models.Index(
                    ...
                    models.Index(
                        fields=["action", "performed_at"], name="idx_audit_action_time"
                    ),
                    models.Index(
                        fields=["table_name", "object_id"],
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("study", "site"), name="unique_study_site"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="studymembership",
            index=models.Index(
                fields=["study", "is_active"], name="idx_membership_study"
            ),
        ),
        migrations.AddConstraint(
            model_name="studymembership",
            constraint=models.UniqueConstraint(
                fields=("user", "study", "role"), name="unique_user_study_role"
            ),
        ),
        migrations.AddIndex(
            model_name="study",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(("db_name__regex", "^db_study_\\w+$")),
